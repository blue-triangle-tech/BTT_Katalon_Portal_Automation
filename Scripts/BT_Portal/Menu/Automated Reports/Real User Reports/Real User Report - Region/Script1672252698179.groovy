...
//***************************************************************************
 ...
 // Script Name: Real User Report - Region
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for Region
...
TestObject region = new TestObject('region')
region.addProperty('text', ConditionType.EQUALS, 'VIRGINIA')
WebUI.click(findTestObject('Object Repository/Automated Reports/Report Filters/filter_region'))
WebUI.click(region)
