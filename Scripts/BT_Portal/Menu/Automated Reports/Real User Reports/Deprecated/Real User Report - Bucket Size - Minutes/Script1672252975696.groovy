...
//***************************************************************************
 ...
 // Script Name: Real User Report - Bucket Size - Minutes
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for bucket size set to "Minutes"
 ...
 //		Sets the bucket size to Minutes
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Automated Reports/Report Filters/filter_bucketSize'), 'Minutes', true)
