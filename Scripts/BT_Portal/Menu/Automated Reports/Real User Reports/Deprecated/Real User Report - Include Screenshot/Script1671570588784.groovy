...
//***************************************************************************
 ...
 // Script Name: Real User Report - Include Screenshot
 //
 ...
 //		Configures the report settings with report_settings() to set the name, subject, time period, and sets screenshot to 'yes'
...
report.report_settings(report_name, report_subject, '7', 'hours', 'Yes')
