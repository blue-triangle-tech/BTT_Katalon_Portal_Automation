...
//***************************************************************************
 ...
 // Script Name: Real User Report - Net Speed
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for Net Speed
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Automated Reports/Report Filters/filter_netSpeed'), 'Cellular', true)
