...
//***************************************************************************
 ...
 // Script Name: Real User Report - Granularity
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for granularity
 ...
 //		Sets the filter for granularity
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Automated Reports/Report Filters/filter_granularity'), '1', true)

if (report_type.getValue(1, row) == 'coreMetricsBySite') {
	TestObject page = new TestObject('page')
	page.addProperty('text', ConditionType.EQUALS, 'product' )
