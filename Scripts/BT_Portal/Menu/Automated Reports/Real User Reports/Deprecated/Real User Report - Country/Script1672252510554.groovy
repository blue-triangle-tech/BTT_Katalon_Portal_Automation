...
//***************************************************************************
 ...
 // Script Name: Real User Report - Country
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for Country
...
TestObject country = new TestObject('country')
country.addProperty('text', ConditionType.EQUALS, 'UNITED STATES')
WebUI.click(findTestObject('Object Repository/Automated Reports/Report Filters/filter_country'))
WebUI.click(country)
