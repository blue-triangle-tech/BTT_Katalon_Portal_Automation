...
//***************************************************************************
 ...
 // Script Name: Real User Report - Buket Size - Hours
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for bucket size set to "Hours"
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Automated Reports/Report Filters/filter_bucketSize'), 'Hours', true)
