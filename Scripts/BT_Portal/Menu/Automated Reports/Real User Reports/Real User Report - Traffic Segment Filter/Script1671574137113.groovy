...
//***************************************************************************
 ...
 // Script Name: Real User Report - Traffic Segment
 //
 // Script Overview: Creates each type of real user report from the Automated Reports page with a filter for Traffic Segment
 ...
 //		Sets the filter for traffic segment
...
TestObject filter_selection = new TestObject('filter selection')
filter_selection.addProperty('text', ConditionType.EQUALS, 'eCommerce')
WebUI.click(filter_selection)
